          ...
          <div className="location-container">
            ...
            <div className="location-row">
              <div className="loc-wrap-img-left">
                <img className="left-loc-img" alt="Rectangle" src={rectangle99} />
              </div>
            ...
            <div className="location-row">
                ...
                <div className="loc-wrap-img-right">
                  <img className="right-loc-img" alt="Rectangle" src={rectangle100} />
                </div>
            </div>

            <div className="location-row">
                <div className="loc-wrap-img-left">
                  <img className="left-loc-img" alt="Rectangle" src={rectangle101} />
                </div>
                <div className="loc-text-box">
            ...
            <div className="location-row">
                ...
                <div className="loc-wrap-img-right">
                  <img className="right-loc-img" alt="Rectangle" src={rectangle102} />
                </div>
            </div>
          </div>
          <img className="absolute-img1" alt="Pexels erik mclean" src={require("../images/tickets-on-hand.png")} />
          <img className="absolute-img2" alt="Pexels rachel claire" src={require("../images/tickets-in-bag.png")} />

          <div className="overlap-15">
              <div className="discounts">Discounts & Memberships</div>
                  <div className="overlap-group-5">
                      <img className="class-img-left" alt="Rectangle" src={rectangle116} />
                  ...
                  <div className="overlap-group-5">
                    ...
                    <img className="class-img-right" alt="Rectangle" src={rectangle117} />
                  </div>
                  <div className="overlap-group-5">
                    <img className="class-img-left" alt="Rectangle" src={rectangle118} />
